...
curl https://raw.githubusercontent.com/Dacung555/setup-ssh-dan-vpn/master/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/Dacung555/setup-ssh-dan-vpn/master/vps.conf > /etc/nginx/conf.d/vps.conf
